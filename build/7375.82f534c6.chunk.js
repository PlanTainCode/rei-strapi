"use strict";
(self["webpackChunkcms"] = self["webpackChunkcms"] || []).push([[7375],{
...
const FormHead = ({ apiToken, setApiToken, canEditInputs, canRegenerate, isSubmitting }) => {
  ...
  return /* @__PURE__ */ react.createElement(HeaderLayout/* HeaderLayout */.T, {
    ...
    primaryAction: canEditInputs ? /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
      horizontal: true,
      spacing: 2
...
const FormApiTokenContainer = ({
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    ...
    onChange,
    disabled: !canEditInputs
  }, values.description)), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, {
    key: "lifespan",
    col: 6,
    xs: 12
...
const CollapsableContentType = ({
  ...
  return /* @__PURE__ */ react.createElement(Accordion/* Accordion */.U, {
    ...
    return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      ...
      variant: "sigma",
      textColor: "neutral600"
    }, controller == null ? void 0 : controller.controller)), /* @__PURE__ */ react.createElement(Border, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      paddingLeft: 4
      ...
      disabled
    }, "Select all"))), /* @__PURE__ */ react.createElement(Grid/* Grid */.r, {
      gap: 4,
      padding: 4
...
const FormBody = ({
  ...
  return /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 6
...
const ApiTokenCreateView = () => {
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContextProvider, {
    value: providerValue
  }, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    name: "API Tokens"

...
const TableBody = ({ sortedRoles, canDelete, permissions, setRoleToDelete, onDelete }) => {
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedRoles == null ? void 0 : sortedRoles.map((role) => /* @__PURE__ */ react.createElement(Tr.Tr, __spreadValues({
    key: role.name
  }, (0,build.onRowClick)({ fn: () => handleClickEdit(role.id) })), /* @__PURE__ */ react.createElement(Cell.Td, {
    width: "20%"
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, role.name)), /* @__PURE__ */ react.createElement(Cell.Td, {
    width: "50%"
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, role.description)), /* @__PURE__ */ react.createElement(Cell.Td, {
    width: "30%"
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, `${role.nb_users} ${formatMessage({
    id: "global.users",
    defaultMessage: "users"
  }).toLowerCase()}`)), /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, __spreadValues({
    justifyContent: "end"
...
const RoleListPage = () => {
  ...
  }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma",
    textColor: "neutral600"
  }, formatMessage({
...
function BoundRoute({ route }) {
  ...
  }), "\xA0", /* @__PURE__ */ react.createElement("span", null, controller), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "delta",
  ...
  }, method)), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 2,
    paddingRight: 2
  }, map_default()(formattedRoute, (value) => /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    key: value,
...
const Policies = () => {
  ...
  return /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, {
    ...
    paddingRight: 7,
    style: { minHeight: "100%" }
  }, selectedAction ? /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 2
...
const SubCategory = ({ subCategory }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    ...
    variant: "sigma",
    textColor: "neutral600"
  }, subCategory.label)), /* @__PURE__ */ react.createElement(Border, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 4
  ...
  }, formatMessage({ id: "app.utils.select-all", defaultMessage: "Select all" })))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    paddingTop: 6,
    paddingBottom: 6
...
const Permissions = () => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 1
  }, collapses.map((collapse, index) => /* @__PURE__ */ react.createElement(Accordion/* Accordion */.U, {
  ...
  }), /* @__PURE__ */ react.createElement(AccordionContent/* AccordionContent */.v, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Permissions_PermissionRow, {
...
const EditPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    ...
    primaryAction: !isLoadingPlugins && /* @__PURE__ */ react.createElement(Button/* Button */.z, {
...
`, m = ({
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_AccordionContext_js__WEBPACK_IMPORTED_MODULE_6__/* .AccordionContext.Provider */ .S.Provider, {
    ...
    variant: i,
    error: s
  }, r), s && g && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Box_Box_js__WEBPACK_IMPORTED_MODULE_3__/* .Box */ .x, {
    paddingTop: 1

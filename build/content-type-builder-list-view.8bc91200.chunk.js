...
function DynamicZoneList({ customRowComponent, components, addComponent, name, targetUid }) {
  ...
  return /* @__PURE__ */ react.createElement(components_Tr, {
    ...
    spacing: 1
  }, /* @__PURE__ */ react.createElement(StyledAddIcon, null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
    fontWeight: "bold",
...
const NestedTFooter = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(ButtonBox, NestedTFooter_spreadValues({
    ...
    as: "button",
    type: "button"
  }, props), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(IconBox, {
    color,
    "aria-hidden": true,
    background: `${color}200`
  }, icon), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 3
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
    fontWeight: "bold",
...
function List({
  ...
  return /* @__PURE__ */ react.createElement(List_BoxWrapper, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, List_spreadValues({
    paddingLeft: 6,
    paddingRight: isMain ? 6 : 0
  }, isMain && { style: { overflowX: "auto" } }), /* @__PURE__ */ react.createElement("table", null, isMain && /* @__PURE__ */ react.createElement("thead", null, /* @__PURE__ */ react.createElement("tr", null, /* @__PURE__ */ react.createElement("th", null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma",
    textColor: "neutral600"
  ...
  })))), isMain && isInDevelopmentMode && /* @__PURE__ */ react.createElement(TFooter/* TFooter */.c, {
...
function ListRow({
  ...
  return /* @__PURE__ */ react.createElement(ListRow_BoxWrapper, ListRow_spreadValues({
    ...
    fontWeight: "bold"
  }, name))), /* @__PURE__ */ react.createElement("td", null, target ? /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, formatMessage({
    id: (0,getTrad/* default */.Z)(
    ...
    customField,
    repeatable
  })), /* @__PURE__ */ react.createElement("td", null, isInDevelopmentMode ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, ListRow_spreadValues({
    justifyContent: "flex-end"
  }, build.stopPropagation), configurable ? /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    horizontal: true,
    spacing: 1
  }, !isMorph && /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, {
    onClick: handleClick,
    label: `${formatMessage({
      id: "app.utils.edit",
      defaultMessage: "Edit"
  ...
  })) : /* @__PURE__ */ react.createElement(w, null)) : /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    height: (0,build.pxToRem)(32)
  })));
}
...
const ListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(react_router_dom_min.Prompt, {
    ...
    id: "title",
    primaryAction: isInDevelopmentMode && /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
      horizontal: true,
      spacing: 2
    }, !isCreatingFirstContentType && /* @__PURE__ */ react.createElement(Button/* Button */.z, {
      startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null),
      variant: "secondary",
      onClick: () => {
        onOpenModalAddField({ forTarget, targetUid });
      }
    }, formatMessage({ id: (0,getTrad/* default */.Z)("button.attributes.add.another") })), /* @__PURE__ */ react.createElement(Button/* Button */.z, {
    ...
    secondaryAction: isInDevelopmentMode && !isFromPlugin && !isCreatingFirstContentType && /* @__PURE__ */ react.createElement(Button/* Button */.z, {

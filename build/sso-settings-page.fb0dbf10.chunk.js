...
const SingleSignOn = () => {
  ...
  }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, showLoader ? /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 4,
    background: "neutral0",
    padding: 6,
    shadow: "filterShadow",
  ...
  }, roles.map(({ id, name }) => /* @__PURE__ */ react.createElement(Option/* Option */.W, {
    key: id,
    value: id.toString()
  }, name))))))))));
};

...
const AttributeIcon = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(IconBox, __spreadProps(__spreadValues({
    as: Compo
  }, rest), {
    "aria-hidden": true
  }));
...
const AllowedTypesSelect = ({ intlLabel, name, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(MultiSelectNested/* MultiSelectNested */.Q, {
    id: "select1",
    label,
...
const AttributeOption = ({ type }) => {
  ...
  return /* @__PURE__ */ react.createElement(OptionBoxWrapper, {
    ...
    type: "button",
    onClick: handleClick
  }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, {
    type
    ...
    fontWeight: "bold"
  }, formatMessage({ id: (0,getTrad/* default */.Z)(`attribute.${type}`), defaultMessage: type }))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
...
const AttributeList = ({ attributes }) => /* @__PURE__ */ react.createElement(KeyboardNavigable/* KeyboardNavigable */.k, {
  tagName: "button"
...
const EmptyAttributes = () => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    position: "relative"
  }, /* @__PURE__ */ react.createElement(EmptyCardGrid, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    position: "absolute",
    top: 6,
    width: "100%"
...
const CustomFieldOption = ({ customFieldUid, customField }) => {
  ...
  return /* @__PURE__ */ react.createElement(OptionBoxWrapper, {
    ...
    fontWeight: "bold"
  }, formatMessage(intlLabel))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
    textColor: "neutral600"
...
const AttributeOptions = ({ attributes, forTarget, kind }) => {
  ...
  return /* @__PURE__ */ react.createElement(ModalBody/* ModalBody */.f, {
    padding: 6
    ...
    variant: "beta",
    as: "h2"
  }, formatMessage({ id: titleId, defaultMessage: "Select a field" })), /* @__PURE__ */ react.createElement(Tabs/* Tabs */.m, null, /* @__PURE__ */ react.createElement(Tabs/* Tab */.O, null, formatMessage({ id: defaultTabId, defaultMessage: "Default" })), /* @__PURE__ */ react.createElement(Tabs/* Tab */.O, null, formatMessage({ id: customTabId, defaultMessage: "Custom" })))), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingBottom: 6
  }, /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null)), /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.n, null, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(AttributeOptions_AttributeList, {
    attributes
  })), /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(AttributeOptions_CustomFieldsList, null)))));
};
...
const DraftAndPublishToggle = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(ToggleInput/* ToggleInput */.s, {
    checked: value || false,
    disabled,
    hint,
    label,
  ...
  }), showWarning && /* @__PURE__ */ react.createElement(Dialog/* Dialog */.V, {
...
const FormModalHeader = ({
  ...
  if (isCreatingMainSchema) {
    ...
    return /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, {
      type: icon
    })), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      paddingLeft: 3
    }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
  ...
  return /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.x, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    horizontal: true,
    spacing: 3
  }, /* @__PURE__ */ react.createElement(AttributeIcon/* default */.Z, {
    type: icon,
    customField: customFieldUid
  }), /* @__PURE__ */ react.createElement(Breadcrumbs/* Breadcrumbs */.O, {
...
const FormModalEndActions = ({
  ...
  if (isContentTypeModal) {
    return /* @__PURE__ */ react.createElement(react.Fragment, null, !isCreatingContentType && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, {
      type: "button",
      variant: "danger",
      onClick: (e) => {
        e.preventDefault();
      ...
      id: "global.finish",
      defaultMessage: "Finish"
    }))), isCreatingContentType && /* @__PURE__ */ react.createElement(Button/* Button */.z, {
      type: "submit",
      variant: "secondary",
      onClick: (e) => {
        e.preventDefault();
  ...
  if (isComponentModal) {
    return /* @__PURE__ */ react.createElement(react.Fragment, null, !isCreatingComponent && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, {
      type: "button",
      variant: "danger",
      onClick: (e) => {
        e.preventDefault();
      ...
      id: "global.finish",
      defaultMessage: "Finish"
    }))), isCreatingComponent && /* @__PURE__ */ react.createElement(Button/* Button */.z, {
      type: "submit",
      variant: "secondary",
      onClick: (e) => {
        e.preventDefault();
...
const BooleanDefaultValueSelect = ({ intlLabel, name, options, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(Select/* Select */.P, {
    label,
    id: name,
    name,
    onChange: handleChange,
...
const CustomRadioGroup = ({ intlLabel, name, onChange, radios, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    ...
    return /* @__PURE__ */ react.createElement("label", {
      ...
      className: "option",
      padding: 4
    }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      paddingRight: 4
      ...
      fontWeight: "bold"
    }, formatMessage(radio.title)), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      variant: "pi",
      textColor: "neutral600"
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/NumberInput/NumberInput.js
var NumberInput = __webpack_require__(21625);
...
const CheckboxWithNumberField = ({ error, intlLabel, modifiedData, name, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    ...
    value: showInput
  }, label), showInput && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 6,
    style: { maxWidth: "200px" }
  }, type === "text" ? /* @__PURE__ */ react.createElement(TextInput/* TextInput */.o, {
    "aria-label": label,
    disabled,
    error: errorMessage,
    id: name,
  ...
  }) : /* @__PURE__ */ react.createElement(NumberInput/* NumberInput */.Y, {
    "aria-label": label,
    disabled,
    error: errorMessage,
    id: name,
...
const ComponentIconPicker = ({ error, intlLabel, name, onChange, value }) => {
  ...
  const errorMessage = error ? formatMessage({ id: error, defaultMessage: error }) : "";
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 1
  }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    justifyContent: "space-between"
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    ...
    style: { width: 206 }
  }, /* @__PURE__ */ react.createElement(Searchbar/* Searchbar */.w, {
    name: "searchbar",
    onBlur: () => {
      if (!search) {
        toggleSearch();
  ...
  }, IconRenderer)), error && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
    id: `${name}-error`,
    textColor: "danger600",
...
const RelationTargetPicker = ({ oneThatIsCreatingARelationWithAnother, target }) => {
  ...
  return /* @__PURE__ */ react.createElement(SimpleMenu/* SimpleMenu */.O, {
    ...
    return /* @__PURE__ */ react.createElement(SimpleMenu/* MenuItem */.s, {
      key: uid,
...
const RelationFormBox = ({
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    ...
    justifyContent: "center"
  }, isMain ? /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
    fontWeight: "bold",
    textColor: "neutral800"
...
const RelationNaturePicker = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    style: { flex: 1 }
  }, /* @__PURE__ */ react.createElement(components_Wrapper, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    paddingLeft: 9,
    paddingRight: 9,
    paddingTop: 1,
    justifyContent: "center"
    ...
    justifyContent: "center"
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, truncate_default()(leftDisplayedValue, { length: 24 }), "\xA0"), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    textColor: "primary600"
  }, formatMessage({ id: (0,getTrad/* default */.Z)(`relation.${relationType}`) }), "\xA0"), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, truncate_default()(rightDisplayedValue, { length: 24 }))));
};
...
const SelectCategory = ({ error, intlLabel, name, onChange, value }) => {
  ...
  return /* @__PURE__ */ react.createElement(Combobox/* CreatableCombobox */.X, {
    error: errorMessage,
    id: name,
    label,
    name,
    ...
    value
  }, categories.map((category) => /* @__PURE__ */ react.createElement(ComboboxOption/* ComboboxOption */.O, {
    key: category,
    value: category
  }, category)));
};
...
const TabForm = ({ form, formErrors, genericInputProps, modifiedData, onChange }) => {
  ...
  return form.map((section, sectionIndex) => {
    ...
    return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      key: sectionIndex
    }, section.sectionTitle && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      paddingBottom: 4
    }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      variant: "delta",
      as: "h3"
    }, formatMessage(section.sectionTitle))), /* @__PURE__ */ react.createElement(Grid/* Grid */.r, {
      gap: 4
...
const TextareaEnum = ({
  ...
  return /* @__PURE__ */ react.createElement(Textarea/* Textarea */.g, {
    disabled,
    error: errorMessage,
    label,
    labelAction,
...
const FormModal = () => {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.P, {
    ...
    attributeName,
    customField
  }), /* @__PURE__ */ react.createElement(Tabs/* Tabs */.m, null, /* @__PURE__ */ react.createElement(Tabs/* Tab */.O, {
    hasError: doesBaseFormHasError
  }, formatMessage({
    id: (0,getTrad/* default */.Z)("popUpForm.navContainer.base"),
    defaultMessage: "Basic settings"
  })), /* @__PURE__ */ react.createElement(Tabs/* Tab */.O, {
    ...
    paddingTop: 6
  }, /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.n, null, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 6
    ...
    modifiedData,
    onChange: handleChange
  }))), /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    spacing: 6
  }, /* @__PURE__ */ react.createElement(components_TabForm, {
    form: advancedForm,
    formErrors,
...
`, SubNavLinkSection_d = ({ label: t, children: p, id: s }) => {
  const [r, m] = (0,react.useState)(!0), l = (0,useId/* useId */.M)("subnav-list", s), c = () => {
    m((n) => !n);
  };
...
SubNavLinkSection_d.defaultProps = {
  id: void 0
};
SubNavLinkSection_d.propTypes = {
...
const ContentTypeBuilderNav = () => {
  ...
  return /* @__PURE__ */ react.createElement(SubNav/* SubNav */.m, {
  ...
  }), /* @__PURE__ */ react.createElement(SubNavSections/* SubNavSections */.Z, null, menu.map((section) => /* @__PURE__ */ react.createElement(react.Fragment, {
    key: section.name
  }, /* @__PURE__ */ react.createElement(SubNavSection/* SubNavSection */.D, {
    label: formatMessage({
      id: section.title.id,
    ...
    if (link.links) {
      return /* @__PURE__ */ react.createElement(SubNavLinkSection_d, {
        key: link.name,
        label: upperFirst_default()(link.title)
      }, link.links.map((subLink) => /* @__PURE__ */ react.createElement(SubNavLink/* SubNavLink */.E, {
  ...
  })), section.customLink && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 7
...
const App = () => {
  ...
  }, /* @__PURE__ */ react.createElement(Layout/* Layout */.A, {

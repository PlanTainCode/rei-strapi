...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data) => {
    ...
    return /* @__PURE__ */ react.createElement(Tr.Tr, __spreadValues({
      key: data.id
    }, (0,build.onRowClick)({
      fn: () => push(`${pathname}/${data.id}`),
      condition: withBulkActions
    })), withMainAction && /* @__PURE__ */ react.createElement(Cell.Td, __spreadValues({}, build.stopPropagation), /* @__PURE__ */ react.createElement(BaseCheckbox/* BaseCheckbox */.C, {
      ...
      return /* @__PURE__ */ react.createElement(Cell.Td, {
        key
      }, typeof cellFormatter === "function" ? cellFormatter(data, __spreadValues({ key, name, formatMessage }, rest)) : /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
        textColor: "neutral800"
      }, data[name] || "-"));
    }), withBulkActions && /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
      justifyContent: "end"
    ...
    }), canDelete && /* @__PURE__ */ react.createElement(Box/* Box */.x, __spreadValues({
      paddingLeft: 1
...
const tableHeaders = [
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(build.Status, {
        isActive,
...
const ListPage = () => {
  ...
  const createAction = canCreate ? /* @__PURE__ */ react.createElement(Button/* Button */.z, {
  ...
  }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, {
    canRead
...
const MagicLinkWrapper = ({ children, target }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.ContentBox, {
    endAction: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_2__.CopyToClipboard, {
      onCopy: handleCopy,
      text: target
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_IconButton__WEBPACK_IMPORTED_MODULE_4__/* .IconButton */ .h, {
      label: copyLabel,
      noBorder: true,
      icon: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_icons_Duplicate__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, null)
    })),
    title: target,
    titleEllipsis: true,
    subtitle: children,
...
const SelectRoles = ({ disabled, error, onChange, value }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Select__WEBPACK_IMPORTED_MODULE_6__/* .Select */ .P, {
    id: "roles",
    disabled,
    error: errorMessage,
    hint,
    ...
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Select__WEBPACK_IMPORTED_MODULE_7__/* .Option */ .W, {
      key: role.id,
      value: role.id
    }, formatMessage({
      id: `global.${role.code}`,

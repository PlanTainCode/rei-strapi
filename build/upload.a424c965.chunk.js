...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.P, {
      onClose: handleClose,
      labelledBy: "title"
    }, /* @__PURE__ */ react.createElement(ModalBody/* ModalBody */.f, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.P, {
    ...
    spacing: 1
  }, /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.Q, {
  ...
  }), errors.destination && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "pi",
    as: "p",
    id: "folder-destination-error",
    textColor: "danger600"
  }, errors.destination))))), /* @__PURE__ */ react.createElement(ModalFooter/* ModalFooter */.m, {
...
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(HeaderLayout/* HeaderLayout */.T, {
    ...
    navigationAction: folder && /* @__PURE__ */ react.createElement(Link/* Link */.r, {
    ...
    primaryAction: canCreate && /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
      horizontal: true,
      spacing: 2
...
const EmptyOrNoPermissions = ({ canCreate, isFiltering, canRead, onActionClick }) => {
  ...
  return /* @__PURE__ */ react.createElement(EmptyAssets/* EmptyAssets */.i, {
    ...
    action: canCreate && !isFiltering && /* @__PURE__ */ react.createElement(Button/* Button */.z, {
      variant: "secondary",
      startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null),
...
const MediaLibrary = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, {
  ...
  }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, selected.length > 0 && /* @__PURE__ */ react.createElement(BulkActions, {
    currentFolder,
    selected,
    onSuccess: selectAll
    ...
    return /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, {
      ...
      cardActions: /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, {
      ...
      fontWeight: "semiBold",
      ellipsis: true
    }, folder.name, /* @__PURE__ */ react.createElement(VisuallyHidden/* VisuallyHidden */.T, null, ":")), /* @__PURE__ */ react.createElement(TypographyMaxWidth, {
      as: "span",
      textColor: "neutral600",
      variant: "pi",
      ellipsis: true
  ...
  })), assetCount > 0 && folderCount > 0 && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingTop: 6,
    paddingBottom: 4
  }, /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null)), assetCount > 0 && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(AssetList/* AssetList */.l, {
    assets,
...
const _ = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].a`
  display: inline-flex;
  align-items: center;
...
`, s = (w) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_, v({
    ...
    href: t ? "#" : e,
    disabled: t
  }, E), d && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(l, {
    as: "span",
    "aria-hidden": !0,
    paddingRight: 2
  }, d), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_Typography_Typography_js__WEBPACK_IMPORTED_MODULE_2__/* .Typography */ .Z, null, o), m && !e && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(l, {
    as: "span",
    "aria-hidden": !0,
    paddingLeft: 2

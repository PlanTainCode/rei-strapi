...
const package_namespaceObject = {"i8":"4.5.2"};
...
const Modal = ({ onClose, onSkip, children, hideSkip }) => {
  ...
  return /* @__PURE__ */ react.createElement(Portal/* Portal */.h, null, /* @__PURE__ */ react.createElement(ModalWrapper, {
    onClick: onClose,
    padding: 8,
  ...
  }, children), !hideSkip && /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    justifyContent: "flex-end"
...
const Content = ({ id, defaultMessage }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    ...
    { id, defaultMessage },
    {
      ...
      b: (children) => /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
        fontWeight: "semiBold"
      }, children),
      p: (children) => /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, children),
      light: (children) => /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
        textColor: "neutral600"
      }, children),
      ul: (children) => /* @__PURE__ */ react.createElement(Box/* Box */.x, {
        paddingLeft: 6
...
const StepNumberWithPadding = ({ number, last, type }) => /* @__PURE__ */ react.createElement(Box/* Box */.x, {
  paddingTop: 3,
...
const StepperModal = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
  ...
  }))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    marginRight: 8,
    minWidth: (0,build.pxToRem)(30)
    ...
    last: true
  }))), /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(components_Content, __spreadValues({}, content)), cta && (cta.target ? /* @__PURE__ */ react.createElement(build.LinkButton, {
    endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.Z, null),
    onClick: onCtaClick,
    to: cta.target
  }, formatMessage(cta.title)) : /* @__PURE__ */ react.createElement(Button/* Button */.z, {
    endIcon: /* @__PURE__ */ react.createElement(ArrowRight/* default */.Z, null),
    onClick: onCtaClick
  }, formatMessage(cta.title))))), hasStepsBefore && hasSectionAfter && /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingTop: 3
  }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    marginRight: 8,
    justifyContent: "center",
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  return /* @__PURE__ */ react.createElement(MainNav/* MainNav */.$, {
    condensed
  }, /* @__PURE__ */ react.createElement(NavBrand/* NavBrand */.D, {
  ...
  }), /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null), /* @__PURE__ */ react.createElement(NavSections/* NavSections */._, null, /* @__PURE__ */ react.createElement(NavLink/* NavLink */.O, {
    as: react_router_dom_min.NavLink,
    to: "/content-manager",
    icon: /* @__PURE__ */ react.createElement(Write/* default */.Z, null),
    onClick: () => handleClickOnLink("/content-manager")
  }, formatMessage({ id: "global.content-manager", defaultMessage: "Content manager" })), pluginsSectionLinks.length > 0 ? /* @__PURE__ */ react.createElement(NavSection/* NavSection */.y, {
    label: formatMessage({
    ...
    return /* @__PURE__ */ react.createElement(NavLink/* NavLink */.O, {
      as: react_router_dom_min.NavLink,
      to: link.to,
      key: link.to,
  ...
  })) : null, generalSectionLinks.length > 0 ? /* @__PURE__ */ react.createElement(NavSection/* NavSection */.y, {
    label: formatMessage({
  ...
  })) : null), /* @__PURE__ */ react.createElement(NavUser/* NavUser */.r, {
  ...
  })), /* @__PURE__ */ react.createElement(Exit/* default */.Z, null))))), /* @__PURE__ */ react.createElement(NavCondense/* NavCondense */.w, {
...
const AppLayout = ({ children, sideNav }) => {
  ...
  }, /* @__PURE__ */ react.createElement(SkipToContent/* SkipToContent */.z, null, formatMessage({ id: "skipToContent", defaultMessage: "Skip to content" })), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ react.createElement(OnboardingWrapper, {
    ...
    icon: free_solid_svg_icons_index_es/* faQuestion */.Psp
  }), isOpen && /* @__PURE__ */ react.createElement(index_es/* FontAwesomeIcon */.G, {
    icon: free_solid_svg_icons_index_es/* faTimes */.NBC
  })), isOpen && /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, {
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(5926), __webpack_require__.e(118), __webpack_require__.e(6593), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 1620))
);
...
const StepLine = (_a) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_2__/* .Box */ .x, __spreadValues({
...
const StepNumber = ({ type, number }) => {
  if (type === _constants__WEBPACK_IMPORTED_MODULE_2__/* .IS_DONE */ .hx) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_3__/* .Flex */ .k, {
      ...
      justifyContent: "center"
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Icon__WEBPACK_IMPORTED_MODULE_4__/* .Icon */ .J, {
      as: _strapi_icons_Check__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z,
      "aria-hidden": true,
  ...
  if (type === _constants__WEBPACK_IMPORTED_MODULE_2__/* .IS_ACTIVE */ .lW) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_3__/* .Flex */ .k, {
      ...
      height: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(30),
      justifyContent: "center"
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_6__/* .Typography */ .Z, {
      fontWeight: "semiBold",
      textColor: "neutral0"
    }, number));
  }

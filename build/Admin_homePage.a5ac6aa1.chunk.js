...
const StepHomepage = ({ type, title, number, content, hasLine }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, {
...
const StepperHomepage = ({ sections, currentSectionKey }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, sections.map((section, index) => /* @__PURE__ */ react.createElement(Step, {
    key: section.key,
    title: section.title,
...
const socialLinks = [
  {
    ...
    icon: /* @__PURE__ */ react.createElement(Github/* default */.Z, {
      fill: "#7289DA"
    }),
    alt: "github"
  },
...
const HomeHeader = ({ hasCreatedContentType, onCreateCT }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 6,
    paddingBottom: 10
  ...
  })), hasCreatedContentType ? /* @__PURE__ */ react.createElement(Link/* Link */.r, {
    isExternal: true,
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(react_intl.FormattedMessage, {
    id: "HomePage.helmet.title",
    defaultMessage: "Homepage"
  }, (title) => /* @__PURE__ */ react.createElement(Helmet.Helmet, {
    title: title[0]
  })), /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(LogoContainer, null, /* @__PURE__ */ react.createElement("img", {
    alt: "",
    "aria-hidden": true,
    ...
    col: 8,
    s: 12
  }, showGuidedTour ? /* @__PURE__ */ react.createElement(Homepage, null) : /* @__PURE__ */ react.createElement(HomePage_ContentBlocks, null)), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, {
    col: 4,
    s: 12

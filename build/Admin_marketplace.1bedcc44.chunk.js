...
const EmptyNpmPackageGrid = () => {
  return /* @__PURE__ */ react.createElement(i, null, Array(12).fill(null).map((_, idx) => /* @__PURE__ */ react.createElement(EmptyPluginCard, {
...
const EmptyNpmPackageSearch = ({ content }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    position: "relative"
  }, /* @__PURE__ */ react.createElement(EmptyNpmPackageGrid, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    position: "absolute",
    top: 11,
    width: "100%"
...
const PageHeader = ({ isOnline, npmPackageType }) => {
  ...
  return /* @__PURE__ */ react.createElement(HeaderLayout/* HeaderLayout */.T, {
    title: formatMessage({
    ...
    primaryAction: isOnline && /* @__PURE__ */ react.createElement(LinkButton/* LinkButton */.Q, {
...
const MissingPluginBanner = () => {
  ...
  return /* @__PURE__ */ react.createElement("a", {
    ...
    endAction: /* @__PURE__ */ react.createElement(Icon/* Icon */.J, {
      as: ExternalLink["default"],
      color: "neutral600",
      width: 3,
      height: 3,
      marginLeft: 2
...
const TooltipButton = ({ description, installMessage, disabled, handleCopy, pluginName }) => /* @__PURE__ */ react.createElement(Tooltip/* Tooltip */.u, {
  "data-testid": `tooltip-${pluginName}`,
  description
}, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, {
  size: "S",
...
const PackageStats = ({ githubStars, npmDownloads, npmPackageType }) => {
  ...
  return /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    horizontal: true,
    spacing: 1
  }, !!githubStars && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, {
    as: Github/* default */.Z,
...
const NpmPackageCard = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    ...
    alignItems: "center"
  }, attributes.name, attributes.validated && !attributes.madeByStrapi && /* @__PURE__ */ react.createElement(Tooltip/* Tooltip */.u, {
    description: formatMessage({
      id: "admin.pages.MarketPlacePage.plugin.tooltip.verified",
      defaultMessage: "Plugin verified by Strapi"
    })
  }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, {
    as: CheckCircle["default"],
    marginLeft: 2,
    color: "success600"
  }))), attributes.madeByStrapi && /* @__PURE__ */ react.createElement(Tooltip/* Tooltip */.u, {
    ...
    variant: "omega",
    textColor: "neutral600"
  }, attributes.description))), /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
    horizontal: true,
    spacing: 2,
...
const NpmPackagesGrid = ({
  ...
  return /* @__PURE__ */ react.createElement(Grid/* Grid */.r, {
    gap: 4
  }, npmPackages.map((npmPackage) => /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, {
    col: 4,
    s: 6,
    xs: 12,
    style: { height: "100%" },
...
const SortSelect = ({ sortQuery, handleSelectChange }) => {
  ...
  return /* @__PURE__ */ react.createElement(SelectWrapper, null, /* @__PURE__ */ react.createElement(Select/* Select */.P, {
    size: "S",
    id: "sort-by-select",
    value: sortQuery,
...
const FiltersPopover = ({
  ...
  return /* @__PURE__ */ react.createElement(Popover/* Popover */.J, {
    ...
    spacing: 1
  }, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(NpmPackagesFilters_FilterSelect, {
  ...
  })), npmPackageType === "plugin" && /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(NpmPackagesFilters_FilterSelect, {
    message: formatMessage({
...
const FilterTag = ({ name, handleRemove }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    padding: 1
  }, /* @__PURE__ */ react.createElement(Tag/* Tag */.V, {
...
const MarketPlacePage = () => {
  ...
  if (!isOnline) {
    return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(components_PageHeader, {
      isOnline
    }), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
      width: "100%",
      direction: "column",
  ...
  if (hasFailed) {
    return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, {
      paddingTop: 8
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(Helmet.Helmet, {
    title: formatMessage({
  ...
  }), " ", "(", providerSearchResults.length, ")"))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, {
    paddingBottom: 4,
    gap: 2
    ...
    handleSelectChange,
    handleSelectClear
  })), /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.n, null, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, searchQuery.length > 0 && !pluginSearchResults.length ? /* @__PURE__ */ react.createElement(components_EmptyNpmPackageSearch, {
  ...
  })), /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, searchQuery.length > 0 && !providerSearchResults.length ? /* @__PURE__ */ react.createElement(components_EmptyNpmPackageSearch, {
    content: emptySearchMessage
  }) : /* @__PURE__ */ react.createElement(components_NpmPackagesGrid, {

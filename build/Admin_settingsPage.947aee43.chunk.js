...
const LogoModalStepper = ({
  ...
  }, /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.x, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    fontWeight: "bold",
    as: "h2",
    id: "modal"
...
const FromComputerForm = ({ setLocalImage, goTo, next, onClose }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement("form", null, /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    paddingLeft: 8,
    paddingRight: 8,
    paddingTop: 6,
    paddingBottom: 6
  ...
  )))), /* @__PURE__ */ react.createElement(FieldError/* FieldError */.c, null)))))), /* @__PURE__ */ react.createElement(ModalFooter/* ModalFooter */.m, {
...
const AddLogoDialog = ({ setLocalImage, goTo, next, onClose }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(TabGroup/* TabGroup */.v, {
    label: formatMessage({
  ...
  }))), /* @__PURE__ */ react.createElement(Divider/* Divider */.i, null)), /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.n, null, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(LogoModalStepper_FromComputerForm, {
    onClose,
    setLocalImage,
    goTo,
    next
  })), /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(LogoModalStepper_FromUrlForm, {
    onClose,
    setLocalImage,
    goTo,
    next
...
const ImageCardAsset = ({ asset }) => {
  const { formatMessage } = (0,react_intl.useIntl)();
  return /* @__PURE__ */ react.createElement(Card/* Card */.Z, null, /* @__PURE__ */ react.createElement(CardHeader/* CardHeader */.O, null, /* @__PURE__ */ react.createElement(CardAsset/* CardAsset */.H, {
    size: "S",
    src: asset.url
  })), /* @__PURE__ */ react.createElement(CardBody/* CardBody */.e, null, /* @__PURE__ */ react.createElement(CardContent/* CardContent */.a, null, /* @__PURE__ */ react.createElement(CardTitle/* CardTitle */.l, null, asset.name), /* @__PURE__ */ react.createElement(CardTitle/* CardSubtitle */._, null, `${asset.ext.toUpperCase()} - ${asset.width}\u2715${asset.height}`)), /* @__PURE__ */ react.createElement(CardBadge/* CardBadge */.E, null, formatMessage({
...
const LogoInput = ({ customLogo, defaultLogo, onChangeLogo, onResetMenuLogo }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(CarouselInput/* CarouselInput */.F, {
    label: formatMessage({
    ...
    actions: /* @__PURE__ */ react.createElement(CarouselActions/* CarouselActions */.b, null, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, {
    ...
    }), customLogo && /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, {
  ...
  }, /* @__PURE__ */ react.createElement(CarouselSlide/* CarouselSlide */.q, {
    label: formatMessage({
...
const ApplicationInfosPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    name: "Application"
  }), /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(HeaderLayout/* HeaderLayout */.T, {
    ...
    as: "p"
  }, "v", strapiVersion), /* @__PURE__ */ react.createElement(Link/* Link */.r, {
    ...
    col: 6,
    s: 12
  }, shouldUpdateStrapi && /* @__PURE__ */ react.createElement(Link/* Link */.r, {
...
const SettingsNav = ({ menu }) => {
  ...
  return /* @__PURE__ */ react.createElement(SubNav/* SubNav */.m, {
    ...
    label
  }), /* @__PURE__ */ react.createElement(SubNavSections/* SubNavSections */.Z, null, sections.map((section) => /* @__PURE__ */ react.createElement(SubNavSection/* SubNavSection */.D, {
    key: section.id,
    label: formatMessage(section.intlLabel)
  }, section.links.map((link) => /* @__PURE__ */ react.createElement(SubNavLink/* SubNavLink */.E, {
...
const ConditionsModal = ({ actions, headerBreadCrumbs, isFormDisabled, onClosed, onToggle }) => {
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.P, {
    ...
    onClose: onClosed
  }, /* @__PURE__ */ react.createElement(ModalHeader/* ModalHeader */.x, null, /* @__PURE__ */ react.createElement(Breadcrumbs/* Breadcrumbs */.O, {
...
const Header = ({ headers, label }) => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(PropertyLabelWrapper, {
    alignItems: "center",
    paddingLeft: 6
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma",
...
const CollapsePropertyMatrix = ({
  ...
  }), /* @__PURE__ */ react.createElement(Box/* Box */.x, null, childrenForm.map(({ children: childrenForm2, label: label2, value, required }, i) => /* @__PURE__ */ react.createElement(CollapsePropertyMatrix_ActionRow, {
...
const Permissions = (0,react.forwardRef)(({ layout, isFormDisabled, permissions }, ref) => {
  ...
  return /* @__PURE__ */ react.createElement(components_PermissionsDataManagerProvider, {
  ...
  }, /* @__PURE__ */ react.createElement(TabGroup/* TabGroup */.v, {
    id: "tabs",
    label: formatMessage({
      id: "Settings.permissions.users.tabs.label",
      defaultMessage: "Tabs Permissions"
    })
  }, /* @__PURE__ */ react.createElement(Tabs/* Tabs */.m, null, tabLabels.map((tabLabel) => /* @__PURE__ */ react.createElement(Tabs/* Tab */.O, {
    key: tabLabel.id
  }, formatMessage({ id: tabLabel.labelId, defaultMessage: tabLabel.defaultMessage })))), /* @__PURE__ */ react.createElement(TabPanels/* TabPanels */.n, {
    style: { position: "relative" }
  }, /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(components_ContentTypes, {
    ...
    kind: "singleTypes",
    isFormDisabled
  })), /* @__PURE__ */ react.createElement(TabPanels/* TabPanel */.x, null, /* @__PURE__ */ react.createElement(PluginsAndSettings, {
...
const RoleRow = ({ id, name, description, usersCount, icons, rowIndex }) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_3__.Tr, __spreadValues({
    ...
    fn: icons[1].onClick
  })), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_4__.Td, {
    maxWidth: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(130)
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_5__/* .Typography */ .Z, {
    ellipsis: true,
    textColor: "neutral800"
  }, name)), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_4__.Td, {
    maxWidth: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(250)
  }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_5__/* .Typography */ .Z, {
    ellipsis: true,
    textColor: "neutral800"
  }, description)), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_4__.Td, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_5__/* .Typography */ .Z, {
    textColor: "neutral800"
  }, usersCountText)), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Table__WEBPACK_IMPORTED_MODULE_4__.Td, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Flex__WEBPACK_IMPORTED_MODULE_6__/* .Flex */ .k, __spreadValues({
    justifyContent: "flex-end"
  }, _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.stopPropagation), icons.map(
    (icon, i) => icon ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Box__WEBPACK_IMPORTED_MODULE_7__/* .Box */ .x, {
      key: icon.label,
      paddingLeft: i === 0 ? 0 : 1
    }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_IconButton__WEBPACK_IMPORTED_MODULE_8__/* .IconButton */ .h, {
...
const UpgradePlanModal = ({ onClose, isOpen }) => {
  ...
  return /* @__PURE__ */ react.createElement(Portal/* Portal */.h, null, /* @__PURE__ */ react.createElement(UpgradeWrapper, {
    onClick: onClose
    ...
    alt: "air-balloon"
  }), /* @__PURE__ */ react.createElement(CloseButtonContainer, null, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, {
    onClick: onClose,
    "aria-label": "Close",
  ...
  }))), /* @__PURE__ */ react.createElement(LinkButton/* LinkButton */.Q, {
    href: "https://strapi.io/pricing-self-hosted",
    isExternal: true,
    endIcon: /* @__PURE__ */ react.createElement(ExternalLink["default"], null)
  }, formatMessage({
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
  ...
  }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Table/* Table */.i, {
    colCount,
    rowCount,
    footer: /* @__PURE__ */ react.createElement(TFooter/* TFooter */.c, {
      onClick: handleToggleModalForCreatingRole,
      icon: /* @__PURE__ */ react.createElement(Plus["default"], null)
    }, formatMessage({
      id: "Settings.roles.list.button.add",
    ...
    id: "global.name",
    defaultMessage: "Name"
  }))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma",
    textColor: "neutral600"
  }, formatMessage({
  ...
  }))))), /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedRoles == null ? void 0 : sortedRoles.map((role, rowIndex) => /* @__PURE__ */ react.createElement(RoleRow/* default */.Z, {
    key: role.id,
    id: role.id,
    name: role.name,
...
const CreatePage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    ...
    noValidate: true
  }, /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(HeaderLayout/* HeaderLayout */.T, {
    ...
    justifyContent: "space-between"
  }, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    fontWeight: "bold"
  }, formatMessage({
    id: "global.details",
    defaultMessage: "Details"
    ...
    col: 6
  }, /* @__PURE__ */ react.createElement(Textarea/* Textarea */.g, {
    label: formatMessage({
      id: "global.description",
      defaultMessage: "Description"
    }),
    ...
    onChange: handleChange
  }, values.description))))), !isLayoutLoading && !isRoleLoading ? /* @__PURE__ */ react.createElement(Box/* Box */.x, {
    shadow: "filterShadow",
    hasRadius: true
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    ...
    primaryAction: canCreate ? /* @__PURE__ */ react.createElement(Button/* Button */.z, {
  ...
  }), canRead && /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Table/* Table */.i, {
    colCount,
    rowCount,
    footer: canCreate ? /* @__PURE__ */ react.createElement(TFooter/* TFooter */.c, {
      onClick: handleNewRoleClick,
      icon: /* @__PURE__ */ react.createElement(Plus["default"], null)
    }, formatMessage({
      id: "Settings.roles.list.button.add",
  ...
  }, /* @__PURE__ */ react.createElement(Thead/* Thead */.h, null, /* @__PURE__ */ react.createElement(Tr.Tr, {
    "aria-rowindex": 1
  }, /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma",
    textColor: "neutral600"
    ...
    id: "global.actions",
    defaultMessage: "Actions"
  }))))), /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedRoles == null ? void 0 : sortedRoles.map((role, index) => /* @__PURE__ */ react.createElement(RoleRow/* default */.Z, {
    key: role.id,
    id: role.id,
    name: role.name,
    description: role.description,

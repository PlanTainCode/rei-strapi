...
const Input = ({
  ...
  if (type === "bool") {
    return /* @__PURE__ */ react.createElement(ToggleInput/* ToggleInput */.s, {
      "aria-label": name,
      checked: value,
      disabled,
      hint,
...
const FormModal = ({
  ...
  return /* @__PURE__ */ react.createElement(ModalLayout/* ModalLayout */.P, {
    ...
    return /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(ModalBody/* ModalBody */.f, null, /* @__PURE__ */ react.createElement(Stack/* Stack */.K, {
      spacing: 1
...
const ProvidersPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
  ...
  }), isLoading || isLoadingForPermissions ? /* @__PURE__ */ react.createElement(build.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Table/* Table */.i, {
    colCount: 4,
    rowCount: rowCount + 1
  ...
  }, /* @__PURE__ */ react.createElement(VisuallyHidden/* VisuallyHidden */.T, null, formatMessage({ id: (0,utils/* getTrad */.OB)("Providers.image"), defaultMessage: "Image" })))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma",
    textColor: "neutral600"
    ...
    variant: "sigma",
    textColor: "neutral600"
  }, formatMessage({ id: (0,utils/* getTrad */.OB)("Providers.status"), defaultMessage: "Status" }))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
    variant: "sigma"
  }, /* @__PURE__ */ react.createElement(VisuallyHidden/* VisuallyHidden */.T, null, formatMessage({
    id: "global.settings",
    defaultMessage: "Settings"
  })))))), /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, providers.map((provider) => /* @__PURE__ */ react.createElement(Tr.Tr, Providers_spreadValues({
    key: provider.name
  }, (0,build.onRowClick)({
    fn: () => handleClickEdit(provider),
    condition: canUpdate
  })), /* @__PURE__ */ react.createElement(Cell.Td, {
    width: ""
  ...
  }, provider.name)), /* @__PURE__ */ react.createElement(Cell.Td, {
    width: "65%"
  }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
  ...
  }))), /* @__PURE__ */ react.createElement(Cell.Td, Providers_spreadValues({}, build.stopPropagation), canUpdate && /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, {

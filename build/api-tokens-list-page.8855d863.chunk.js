...
const TableRows = ({ canDelete, canUpdate, canRead, onClickDelete, withBulkActions, rows }) => {
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, apiTokens.map((apiToken) => {
    return /* @__PURE__ */ react.createElement(Tr.Tr, DynamicTable_spreadValues({
      key: apiToken.id
    }, (0,build.onRowClick)({
      fn() {
      ...
      fontWeight: "bold"
    }, apiToken.name)), /* @__PURE__ */ react.createElement(Cell.Td, {
      maxWidth: (0,build.pxToRem)(250)
    }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      textColor: "neutral800",
      ellipsis: true
    }, apiToken.description)), /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      textColor: "neutral800"
    }, /* @__PURE__ */ react.createElement(build.RelativeTime, {
      timestamp: new Date(apiToken.createdAt)
    }))), /* @__PURE__ */ react.createElement(Cell.Td, null, apiToken.lastUsedAt && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, {
      textColor: "neutral800"
    }, /* @__PURE__ */ react.createElement(build.RelativeTime, {
...
const ApiTokenListView = () => {
  ...
  }), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, !canRead && /* @__PURE__ */ react.createElement(build.NoPermissions, null), shouldDisplayDynamicTable && /* @__PURE__ */ react.createElement(build.DynamicTable, {
    headers,
